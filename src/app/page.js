...
export default function Home() {
  return (
    <>
      <div class="py-5 max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="bg-blue-600 bg-[url('https://preline.co/assets/svg/examples/abstract-1.svg')] bg-no-repeat bg-cover bg-center p-4 rounded-lg text-center">
          <p class="me-2 inline-block text-white">
            Under Construction. Meanwhile
          </p>
          <a
            class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border-2 border-white text-white hover:border-white/70 hover:text-white/70 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
      ...
      <div className="mt-[40px] max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Grid */}
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              Get Started with{" "}
              <span className="text-blue-600">Base-Detect</span>
            </h1>
            <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">
              A Base Object Detection App Using{" "}
              <a
                className="underline underline-offset-1 hover:text-blue-500 transition-all"
                href="https://www.tensorflow.org/"
              >
                TensorFlow
              </a>{" "}
              for your next project using Kotin Exclusively for Android Devices.
            </p>
            {/* Buttons */}
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              <a
                className="shadow-xl shadow-blue-900 transition-all py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="/obj-detect-john.apk"
              >
                Download APK
                <svg
              ...
              <a
                className="transition-all py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="https://kotlinlang.org/"
              >
                Learn more about Kotin
              </a>
            </div>
            {/* End Buttons */}
            {/* Review */}
          ...
          <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
            <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
              <h2 className="text-2xl text-gray-800 font-bold sm:text-3xl dark:text-gray-200">
                Fully customizable to Kickstart your project
              </h2>
              {/* Tab Navs */}
              <nav
              ...
              >
                <button
                  type="button"
                  className="focus:bg-white focus:shadow-md focus:hover:border-transparent text-start hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:focus:bg-slate-900 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 active"
                ...
                >
                  <span className="flex">
                    <svg
                      className="flex-shrink-0 mt-2 h-6 w-6 md:w-7 md:h-7 focus:text-blue-600 text-gray-800 dark:focus:text-blue-500 dark:text-gray-200"
                      xmlns="http://www.w3.org/2000/svg"
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold focus:text-blue-600 text-gray-800 dark:focus:focus:text-blue-500 dark:text-gray-200">
                        Easy to use
                      </span>
                      <span className="block mt-1 text-gray-800 dark:focus:text-gray-200 dark:text-gray-200">
                        This Kotlin app is a basic starting point for your next
                        big project.
                      </span>
                    </span>
                  </span>
                ...
                <button
                  type="button"
                  className="focus:bg-white focus:shadow-md focus:hover:border-transparent text-start hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:focus:bg-slate-900 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold focus:text-blue-600 text-gray-800 dark:focus:text-blue-500 dark:text-gray-200">
                        Beginner Machine Learning Model
                      </span>
                      <span className="block mt-1 text-gray-800 dark:focus:text-gray-200 dark:text-gray-200">
                        This Kotlin app consists of a basic image recognition
                        model which is easy to train
                      </span>
                    </span>
                  </span>
                </button>
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      ...
                      <span className="block mt-1 text-gray-800 dark:focus:text-gray-200 dark:text-gray-200">
                        Reduce time and effort on Detection quickly and easily.
                      </span>
                    </span>
                  </span>
                </button>
          ...
          <div className="lg:col-span-4">
            ...
            <div className="lg:pe-6 xl:pe-12">
              ...
              <p className="mt-2 sm:mt-3 text-gray-500">
                of recognition accuracy in the last 6 months
              </p>
            </div>
            {/* End Stats */}
          </div>
          ...
          <div className="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-start-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:dark:bg-gray-700">
            <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-500">in quickness</p>
              </div>
              {/* End Stats */}
              {/* Stats */}
              <div>
                <p className="text-3xl font-semibold text-blue-600">10,000+</p>
                <p className="mt-1 text-gray-500">Times Used</p>
              </div>
              {/* End Stats */}
              {/* Stats */}
              <div>
                ...
                <p className="mt-1 text-gray-500">
                  increase in demand this year alone
                </p>
              </div>
              {/* End Stats */}
            </div>
      ...
      <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="text-center">
          ...
          <div className="mt-3">
            ...
            <p className="text-gray-500">
              © BaseDetect. All rights reserved.
            </p>
          </div>
          {/* Social Brands */}
